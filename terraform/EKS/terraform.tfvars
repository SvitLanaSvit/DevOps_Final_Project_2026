/*
  Цей файл містить змінні, які використовуються для налаштування інфраструктури EKS за допомогою Terraform. Він включає конфігурацію AWS, загальні параметри для всіх компонентів інфраструктури, а також специфічні налаштування для VPC, підмереж та тегів.
*/
